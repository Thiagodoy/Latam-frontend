  ...
  <div>
    <div v-if="show=='home'" class="home">
      <div class="topo text-center">
        <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Informações detalhada
      </div>
    ...
    <div v-if="show=='calender'" class="calender-frequency">
      <calender-informacoes  :dataObject="dataObject" @back="show = 'home'"></calender-informacoes>
    </div>
...
import CalenderInformacoes from './calender-informacoes.vue'
