  ...
  <div>
    <div v-if="show=='home'" class="home">
      <div class="topo text-center">
        <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Frequência detalhada
      </div>
    ...
    <div v-if="show=='calender'" class="calender-frequency">
      <calender-frequency  :dataObject="dataObject" @back="show = 'home'"></calender-frequency>
    </div>
...
import CalenderFrequency from './calender-frequency.vue'
