               ...
               <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group" >
                            ...
                            <input type="text" class="form-control campos" :placeholder="$t('lang.table_agency_name')"  >
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" >
                            <label >{{$t('lang.table_agency_input_path')}}</label>
                            <input type="text" class="form-control campos" :placeholder="$t('lang.table_agency_input_path')"   >
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" >
                            <label >{{$t('lang.table_agency_processed_path')}}</label>
                            <input type="text" class="form-control campos" :placeholder="$t('lang.table_agency_processed_path')"   >
                        </div>
                    </div>
                    </div>
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <div class="form-group" >
                                ...
                                <input type="text" class="form-control campos" :placeholder="$t('lang.table_agency_local_file_path')"   >
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group" >
                                ...
                                <input type="text" class="form-control campos" :placeholder="$t('lang.table_agency_code')"   >
                            </div>
                        </div>
                    </div>
